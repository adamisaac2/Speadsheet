...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTests
    {
        ...
        public void ReplaceThenEnumerate()
        {
            ...
            Console.WriteLine("Dependees of 'a' after replacements: " + string.Join(", ", t.GetDependees("a")));
            Console.WriteLine("Dependees of 'b' after replacements: " + string.Join(", ", t.GetDependees("b")));
            Console.WriteLine("Dependees of 'c' after replacements: " + string.Join(", ", t.GetDependees("c")));
            Console.WriteLine("Dependees of 'd' after replacements: " + string.Join(", ", t.GetDependees("d")));
